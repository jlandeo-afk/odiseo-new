...
export class MaterialsController {
  ...
  @ApiOperation({ summary: 'Solicitar generación asíncrona de balotario/examen' })
  @ApiResponse({ status: 202, description: 'La solicitud ha sido encolada exitosamente.' })
  ...
  @ApiOperation({ summary: 'Webhook interno para actualización de estado desde el Worker' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Remover una pregunta específica durante la curaduría manual' })
  @ApiParam({ name: 'jobId', type: 'string', description: 'ID del job de generación' })
  @ApiParam({ name: 'questionId', type: 'string', description: 'ID de la pregunta a remover' })
  @ApiResponse({ status: 200, description: 'Pregunta removida de forma atómica.' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Regenerar una pregunta específica durante la curaduría manual' })
  @ApiParam({ name: 'jobId', type: 'string' })
  @ApiParam({ name: 'questionId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Nueva pregunta generada devuelta.' })
  ...
  @Put(':jobId/complete')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Completar la curaduría manual y reanudar generación física' })
  @ApiParam({ name: 'jobId', type: 'string' })
  ...
  @ApiParam({ name: 'jobId', type: 'string' })
  @ApiResponse({ status: 200, description: 'Preguntas completadas automáticamente.' })
