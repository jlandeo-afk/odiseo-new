...
- [ ] T015 [US2] Update `worker-fastapi/app/core_api_client.py` para detectar y validar cantidad de reactivos vs. `requested_quantity` y lanzar excepción controlada.
